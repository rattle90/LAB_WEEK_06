...
class CatViewHolder(
    ...
    private val onClickListener: OnClickListener // <-- Menggunakan 'O' besar
    ...
    fun bindData(cat: CatModel) {
        containerView.setOnClickListener {
            // Memanggil fungsi yang benar: onItemClick
            onClickListener.onCatClick(cat)
        }
    ...
    // Mendeklarasikan interface OnClickListener
    interface OnClickListener {
        // Nama fungsi diubah menjadi onItemClick
        fun onCatClick(cat: CatModel)
    }
}